...
team1 = ['Riven','Ezreal','Nidalee','Cassiopeia','Thresh'];
team2 = ['Evelynn','LeeSin','Shaco','Quinn','Vladimir'];
...
for (var i = 0; i < team1.length; ++i) {
	console.log(champs_ids[team1[i]]);
}

for (var i = 0; i < team2.length; ++i) {
	console.log(champs_ids[team2[i]]);
}

for (var i = 0; i < team1.length; ++i) {
	vector1[champs_ids[team1[i]]] = 1;
	vector1[124 + champs_ids[team2[i]]] = 1;

	vector2[124 + champs_ids[team1[i]]] = 1;
	vector2[champs_ids[team2[i]]] = 1;
}
...
console.log("Probabilidad de que gane el equipo 1: " + prAvg);
console.log("Probabilidad de que gane el equipo 2: " + (1-prAvg));